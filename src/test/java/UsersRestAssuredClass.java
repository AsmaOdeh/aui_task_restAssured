...
//--------------------------------------------------------------------------------------
        ...
        /*Response myId =response.then().contentType(ContentType.JSON).extract().path("id");
        System.out.println("The returned id is <" + myId.body().asString() + ">");*/


        JsonPath jsonPathEvaluator1 = response1.jsonPath();
        String idFromPost = jsonPathEvaluator1.getString("id");
        System.out.println("The returned id is <" + idFromPost+">");
    ...
    public static void positveGetTest (){
        ...
        Response idResponse = idRequest.request(Method.GET, "/"+extractedID+"?page=2");


        //Return the content of the response body for a specific id
        String idResponseBody = idResponse.getBody().asString();
        System.out.println("Response Body for " +extractedID+ " is =>  " + idResponseBody);
        ...
        System.out.println("The user with ID #"+extractedID+" is <"+firstName+"> <"+lastName+">");
